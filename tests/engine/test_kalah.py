...
def test_initial_state_has_the_configured_seeds_per_cup(seeds: int) -> None:
    kalah = Kalah(KalahConfig(seeds_per_cup=seeds))
    assert kalah.initial_state().board == ((seeds,) * 6, (seeds,) * 6)
